...
class TestDistributedByHash(ConfluentFixtures):
    ...
    Validation of malformed `distributed_by` configs is covered exhaustively
    by the pure-Python unit tests in
    tests/unit/test_validate_distributed_by_config.py — no live run needed."""
